...
cls
title IP LOOKUP Duwa | SΞTH#3109
cls
color c
echo.
echo ██╗██████╗     ██╗      ██████╗  ██████╗ ██╗  ██╗██╗   ██╗██████╗ 
...
:ip-tracer
title IP TRACER by wyd Kex#6363
mode con lines=15 cols=70
cls
color 3
echo.
...
title NAME LOOKUP by Duwa | SΞTH#3109
cls
color e
echo.
echo ███╗   ██╗ █████╗ ███╗   ███╗███████╗    ██╗      ██████╗  ██████╗ ██╗  ██╗██╗   ██╗██████╗ 
